...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Pensiones de: <b><?= date('M'); ?></b></h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Detalle de pensiones del mes de: <?= date('M'); ?></h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-12">
                                ...
                                <div class="form-check mb-1">
                                    ...
                                    <label class="form-check-label" for="inactivas">Inactivas</label>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <select id="n-estatus" name="n-estatus" class="js-example-basic-single form-control-sm" style="width: 100%">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <select id="e-estatus" name="e-estatus" class="js-example-basic-single form-control-sm" style="width: 100%" disabled>
                                            <option value="" selected disabled>Elige una opción</option>
                                            <option value="1">ACTIVA</option>
                                            <option value="0">INACTIVA</option>
                                        </select>
...
<div class="modal fade bd-example-modal-lg" id="modalFicha" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="frm-subirFicha" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
        ...
        function fn_tblPensiones(data) {
            table = $('#tblPensiones').DataTable({
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    // Total oall pages
                    costo = api.column(14).data().reduce(function(a,b) {
                        return parseFloat(intVal(a)) + parseFloat(intVal(b));
                    }, 0);

                    pago = api.column(16).data().reduce(function(a,b) {
                        return parseFloat(intVal(a)) + parseFloat(intVal(b));
                    }, 0);
                    ...
                    $(api.column(23).footer()).html("$"+formatNumber(totalOtros, 2));
                },
                "language": {
                    "url": "<?= base_url(); ?>public/vendor/datatables/language/spanish.json"
                },
