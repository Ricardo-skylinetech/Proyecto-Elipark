                    ...
                    <div class="form-group">
                         <div class="row">
                           ...
                           <div class="row">
                            <div class="col-sm-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="cheacumula" id="cheacumula" value="1">
                                    <label class="form-check-label" for="mes">Acumulado</label>
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3">
                                <input type="month" class="form-control form-control-sm" id="acumuladoIni" name="acumuladoIni">
                            </div>
                                a
                             <div class="col-sm-3 col-md-3">
                                <input type="month" class="form-control form-control-sm" id="acumuladoFin" name="acumuladoFin">
                            </div>
    ...
    $(document).ready(function(){
       ...
       /* $('#n-estatus').select2({
        ...
        var table = $('#tblPensiones').DataTable({
                ...
                "columnDefs": [
                    {
                         "targets": [0,7,8,9,10,11,12,16,18,19,20,21,22,23,24,25,26],
                        "visible": false,
                        "searchable": true
                    }
                ],
        ...
        function fn_tblPensiones(data) {
           ...
           // console.log("entra");
            ...
            table = $('#tblPensiones').DataTable({
                ...
                "columns": [
                    {"data":"id_cat_pensiones","width":"1%"}, //0
                    {"data":"contrato","width":"10%",className: "text-center"},//1
                    {"data":"fechaAlta","width":"10%",className: "text-center"},//2
                    {"data":"fechaBaja","width":"10%",className: "text-center"},//3
                    {"data":"tarjetaSistema","width":"15%"},//4
                    {"data":"tarjetaFisica","width":"15%"},//5
                    {"data":"razonSocial","width":"30%",className: "text-center"},//6
                    {"data":"asignado"},//7
                    {"data":"marca"},//8
                    {"data":"modelo"},//9
                    {"data":"color"},//10
                    {"data":"placas"},//11
                    {"data":"tipoPension"},//12
                    {"data":"estatus","width":"5%", className: "text-center",//13
                     ...
                     {"data":"mes",className: "text-center"}, //14
                    {
                        "data":"costo", //14  ahora 15
                        "render": function(data, type, full, meta) {
                            return "$&nbsp;"+data;
                        }
                    },
                    {"data":"factura"},//15  16
                    {
                        "data":"pago",className: "text-center",//16  17
                        "render": function(data, type, full, meta) {
                            return "$&nbsp;"+data;
                        }
                    },
                    {"data":"venta"}, //17 18
                    {"data":"reposicion"},//18  19
                    {"data":"recargos"},//19 20
                    {"data":"fechaDeposito"},//20 21
                    {"data":"movimiento"},//21 22
                    {"data":"observaciones"},//22 23
                    {"data": "costoSuma"},//23 24
                    {"data":"costoPago"},//24 25
                    {"data":"totalOtros"},//25 26
                    {
                        "defaultContent": "",
                        "render": function(data, type, full, meta) {
                ...
                footerCallback: function(row, data, start, end, display) {
                   ...
                   // var  precioCosto=0;
                    ...
                    costo = api.column(24).data().reduce(function(a,b,validaStatus) { //antes columna 14
                           return parseFloat(intVal(a)) + parseFloat(intVal(b));
                
                    }, 0);


                    pago = api.column(25).data().reduce(function(a,b) { //antes 16
                        return parseFloat(intVal(a)) + parseFloat(intVal(b));
                    }, 0);


                    totalOtros = api.column(26).data().reduce(function(a,b) { //antes 16
                        return parseFloat(intVal(a)) + parseFloat(intVal(b));
                    }, 0);
                   ...
                   totalGral=pago+totalOtros;
                    ...
                    $(api.column(15).footer()).html("$"+formatNumber(costo, 2));
                    $(api.column(17).footer()).html("$"+formatNumber(pago, 2));
                    $(api.column(27).footer()).html("$"+formatNumber(totalOtros, 2));
                    $(api.column(28).footer()).html("$"+formatNumber(totalGral, 2));
                },
                "language": {
                    "url": "<?= base_url(); ?>public/vendor/datatables/language/spanish.json"
                },
         ...
         const checkbox = document.getElementById('cheacumula');
         checkbox.addEventListener('change', function () {

             var column = table.column(29);
             column.visible(!column.visible());

             var column = table.column(30);
             column.visible(!column.visible());

             var column = table.column(31);
             column.visible(!column.visible());
        if (this.checked) {
            

            console.log('El checkbox fue marcado');
        } else {
           
            $("#acumuladoIni").val("");
            $("#acumuladoFin").val("");
            console.log('El checkbox fue desmarcado');
        }
       });
